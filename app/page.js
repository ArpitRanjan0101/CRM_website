  ...
  return (
    <main className="min-h-screen relative bg-[#0b1220]">
      ...
      <div className="fixed bottom-8 right-8 z-50">
        <button className="w-14 h-14 bg-[#00b274] rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform active:scale-95">
      ...
      {/* Sticky Bottom Help Bar (as seen in image) */}
